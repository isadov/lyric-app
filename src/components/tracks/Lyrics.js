...
class Lyrics extends Component {
	...
	render() {
		...
		if(
			...
			return (
				// console.log(track.primary_genres.music_genre_list[0].length)
				<React.Fragment>
					...
					<ul className="list-group mt-3">
						...
						<li className="list-group-item">
							...
							{track.primary_genres.music_genre_list.length >= 1 ? `${track.primary_genres.music_genre_list[0].music_genre.music_genre_name}` : `No Genre` }
						</li>
						<li className="list-group-item">
